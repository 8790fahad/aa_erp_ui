      ...
      <div className="p-">
        ...
        <div className="grid grid-cols-2 gap-2 mb-1">
          ...
          <div className="bg-blue-50 border border-blue-200 p-1.5">
            ...
            <div className="mt-2 border-t border-blue-300 pt-4">
        ...
        {/* Page Footer */}
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-r-4 border-l-4 border-blue-500 p-1 shadow-sm">
...
const OperatingExpenseBillPdf = () => {
  ...
  const handleReactToPrint = useReactToPrint({
    contentRef: pdfRef,
    documentTitle: `Operating-Expense-Bill-${invoiceRef || refNumber || "N/A"}`,
    pageStyle: `
      @page {
        size: A4;
        margin: 0 !important;
...
export default OperatingExpenseBillPdf;

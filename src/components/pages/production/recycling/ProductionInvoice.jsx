...
function ProductionInvoice() {
  ...
  useEffect(() => {
    ...
    _fetchApi(
      `/v1/materials/get-production/${receiptNo}/${facilityId}`,
      (data) => {
  ...
  let amountPaid = txnList.reduce((a, b) => a + parseFloat(0), 0);
  let grandTotal =
  ...
  const downloadInvoice = async () => {
    ...
    link.href = url;
    link.download = `Invoice_${receiptNo}.pdf`;
    link.click();
  ...
  return (
    <Container>
      <CustomCard back header="Production Invoice" id="non-print">
        {!printRec && !preview ? (
          <>
            {/* Header Info */}
            <div className="mb-3 md:mb-1 mt-3 text-center md:!text-left md:!text-left pb-3">
            ...
            <div className="mt-5 flex flex-wrap gap-3 justify-center">
              ...
              >
                <MdPrint size={20} />{" "}
                {window.innerWidth < 768 ? "Download Invoice" : "Print Invoice"}
              </CustomButton>
          ...
          <div className="d-flex pb-5 justify-content-center flex-col">
            <div className="m-2">
                ...
                <div className="mt-3">
                  <div className="flex justify-between border-t border-b py-2 text-sm">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-gray-600">
                        {formatNumber(item.quantity_in)} (KG)
                      </span>
                    </div>
                  </div>
                </div>

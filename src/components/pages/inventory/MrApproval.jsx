                ...
                <div className="mb-4 bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="w-full px-3 py-2 border-2 border-gray-300 rounded-md focus:ring-2 focus:ring-[var(--aa-accent)] focus:border-[var(--aa-accent)]"
                    />
                              ...
                              <div className="flex justify-end">
                                {parseFloat(item.quantity_balance || 0) <= 0 ? (
                                  ...
                                  <Input
                                    ...
                                    placeholder="0.0000"
                                    className="w-full text-right border border-gray-300 rounded-md px-3 py-2 focus:ring-2 focus:ring-[var(--aa-accent)] focus:border-[var(--aa-accent)]"
                                    inputMode="decimal"
                                  />
                                )}
                              </div>

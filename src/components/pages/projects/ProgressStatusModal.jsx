                            ...
                            <div className="p-6 flex-1 overflow-y-auto">
                                ...
                                <div className="mb-4">
                                    ...
                                    <select
                                        ...
                                        className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[var(--aa-accent)] focus:border-transparent ${errors.progress_status ? "border-red-500" : ""
                                            }`}
                                    >

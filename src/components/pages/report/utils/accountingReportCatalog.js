...
export const ACCOUNTING_REPORT_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Sales Summary",
        description: "Invoices, lines, quantity, sales and VAT totals for a period",
        path: "/app/sales/sales-line-report?view=summary",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales Detail",
        description: "Every sales line with customer, product, and salesperson",
        path: "/app/sales/sales-line-report?view=detail",
        dateMode: "range",
        external: true,
      },
      {
        title: "Daily Sales",
        description: "Sales lines totalled by day",
        path: "/app/sales/sales-line-report?view=daily",
        dateMode: "range",
        external: true,
      },
      {
        title: "Monthly/Annual Sales",
        description: "Sales totalled by month, with annual totals",
        path: "/app/sales/sales-line-report?view=monthly",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales by Customer",
        description: "Sales totalled per customer",
        path: "/app/sales/sales-line-report?view=customer",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales by Product",
        description: "Sales totalled per product",
        path: "/app/sales/sales-line-report?view=product",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales by Category",
        description: "Sales totalled per product category",
        path: "/app/sales/sales-line-report?view=category",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales by Salesperson",
        description: "Sales totalled per salesperson",
        path: "/app/sales/sales-line-report?view=salesperson",
        dateMode: "range",
        external: true,
      },
      {
        title: "Sales by Branch",
        description: "Sales totalled per branch / warehouse",
        path: "/app/sales/sales-line-report?view=branch",
        dateMode: "range",
        external: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Suppliers we have paid in advance, not yet used on a purchase",
        path: `${BASE}/advance-report`,
        dateMode: "asOf",
      },
    ],
  },

...
// Import the same fonts as the original
...
// Use the exact same styles from your original VoucherDocument
...
CombinedVoucherDocument.propTypes = {
  vouchers: PropTypes.array.isRequired,
};

export function CombinedVoucherDocument({ vouchers, activeBusiness }) {
  ...
  return (
    <Document>
      {vouchers.map((voucherData, index) => (
        <Page key={voucherData.voucherNo || index} size="A4" style={styles.page}>
          {/* Watermark */}
